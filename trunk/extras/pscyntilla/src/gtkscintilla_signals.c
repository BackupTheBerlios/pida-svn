...
/* ---------------------------------------------------------------------- */
/* default signals handlers declarations */
static void 
gtk_scintilla_default_signal__style_needed(GtkWidget* w, gint position, 
					   gpointer user_data);


/* ---------------------------------------------------------------------- */
/* Use to set default behaviour for set of handled signals. 
   An example for one signal is provided.  */
void gtk_scintilla_set_default_signals(GtkScintillaClass* klass)
{
  /* this is provided as an example: */
  klass->StyleNeeded = &gtk_scintilla_default_signal__style_needed;
  
}


/* ---------------------------------------------------------------------- */
/* Default signals handlers: */
